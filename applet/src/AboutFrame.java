...
public class AboutFrame extends JFrame implements ActionListener
{
	...
	public AboutFrame(Gui currentGui)
	{
		...
		JLabel informationLabel = new JLabel("<html><pre>Robots v1.00<br>Based on the unix game of the same name.<br>code: Jacob Patterson<br>Special thanks to CKHS AP-CS:AB 2009</pre></html>");
