...
them yourself, but luckily, you can make them destroy each other.  Move
around the board with the numpad on your keyboard with numlock on. '5'
...
the numpad.  Be careful, this can be risky, for if the player moves on
or near a robot you will be killed.  Some game modes give the player a 
"safe" teleport" option, a special amount given for each level.  The 
player can choose to not use or save the teleport for a later time by 
pressing '*' on the numpad in a "safe teleports" mode.
    To get safe teleports, press the 'ENTER' key to start WAIT mode.  
In wait mode, all the robots move toward you step by step as if you were
continously pressing the '5' key.  The robots keep moving toward you 
until you die or they all die.  If you survive the wait, you are granted
an amount of safe teleports equal to the number of robots alive when you
started the wait.  The number is capped to 10.  If you get over 10 safe 
teleports, the excess ones will be saved so that when you start new 
games they are initially present (once again, up to 10).
